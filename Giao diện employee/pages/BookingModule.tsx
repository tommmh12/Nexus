        ...
        return (
            <div className="flex items-center justify-center h-96">
                <div className="flex flex-col items-center gap-3">
                    ...
                    <p className="text-slate-500 font-medium text-sm animate-pulse">Đang tải không gian...</p>
                </div>
            </div>
        );
    }
                    ...
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 max-w-7xl mx-auto">
                        <div>
                            <div className="flex items-center gap-2 text-sm text-slate-500 mb-1">
                                ...
                                <span className="text-slate-900 font-medium">Phòng họp</span>
                            </div>
                            ...
                            <p className="text-slate-500 mt-1 max-w-xl">
                                Tìm kiếm và đặt không gian hoàn hảo cho cuộc họp của bạn. Lọc theo tầng, thời gian hoặc sức chứa.
                            </p>
                        </div>
                    ...
                    <div className="flex flex-col lg:flex-row gap-8">
                        ...
                        <div className="flex-1 min-w-0">
                            ...
                            {roomAvailability.length > 0 ? (
                                                        ...
                                                        <div className="mt-auto pt-4 border-t border-slate-100 border-dashed">
                                                            {(status === "booked" || status === "pending") && room.bookings.length > 0 ? (
                                                                <div className="bg-slate-50 rounded-lg p-2.5">
                                                                    <p className="text-xs text-slate-400 mb-1 font-medium uppercase tracking-wider">Cuộc họp hiện tại</p>
                                ...
                                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl border border-slate-200 border-dashed">
                                    ...
                                    <h3 className="text-slate-900 font-bold text-lg mb-2">Không tìm thấy phòng</h3>
                                    <p className="text-slate-500 text-center max-w-xs">
                                        Vui lòng thử thay đổi tầng hoặc thời gian tìm kiếm.
                                    </p>
                                </div>
                            )}
                        </div>
                        ...
                        <div className="w-full lg:w-80 space-y-6 lg:sticky lg:top-24 h-fit">
                            ...
                            <div className="bg-gradient-to-br from-brand-600 to-brand-700 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden">
                                ...
                                <h3 className="font-bold text-lg mb-1 relative z-10">Xin chào, User</h3>
                                <p className="text-brand-100 text-sm mb-6 relative z-10">Bạn có {userBookings.filter(b => b.status === 'approved').length} cuộc họp đã xác nhận.</p>

                                <div className="grid grid-cols-2 gap-3 relative z-10">
                                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/10">
                                        <p className="text-2xl font-bold">{userBookings.length}</p>
                                        <p className="text-[10px] uppercase tracking-wider text-brand-100 font-medium">Tổng số</p>
                                    </div>
                                    <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/10">
                                        <p className="text-2xl font-bold">{floors.length}</p>
                                        <p className="text-[10px] uppercase tracking-wider text-brand-100 font-medium">Tầng</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            {userBookings.length > 0 && (
                                <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                                    <div className="p-4 border-b border-slate-100 flex items-center justify-between">
                                        ...
                                        <button className="text-xs text-brand-600 hover:text-brand-700 font-medium">Xem tất cả</button>
                                    </div>
