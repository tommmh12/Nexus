      ...
      <div className="space-y-3 mt-4">
          ...
          <div className="flex justify-between text-xs mb-1">
            ...
            <span
              className={`font-medium ${
                cpu > 80 ? "text-red-600" : "text-slate-700"
              }`}
            >
              {cpu}%
            </span>
        ...
        <div>
          <div className="flex justify-between text-xs mb-1">
            ...
            <span
              className={`font-medium ${
                ram > 80 ? "text-red-600" : "text-slate-700"
              }`}
            >
              {ram}%
            </span>
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500 mt-1">
            Giám sát hạ tầng máy chủ và trạng thái dịch vụ thời gian thực
          </p>
        </div>
        <div className="flex gap-2">
          <Button variant="outline" className="text-xs">
            <Clock size={14} className="mr-2" /> 24 giờ qua
          </Button>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="text-xs text-green-600 flex items-center mt-1">
            <ArrowDownRight size={14} className="mr-1" /> Giảm 5% so với hôm qua
          </div>
        </div>
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
        ...
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="text-xs text-green-600 flex items-center mt-1">
            <ArrowUpRight size={14} className="mr-1" /> Peak lúc 10:00 AM
          </div>
        </div>
        <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center text-sm">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded bg-brand-500"></div> Documents
              </div>
            ...
            <div className="flex justify-between items-center text-sm">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded bg-emerald-500"></div> Database
              </div>
              <span className="font-medium text-slate-700">800 GB</span>
            </div>
            <div className="flex justify-between items-center text-sm">
              <div className="flex items-center gap-2">
                <div className="w-3 h-3 rounded bg-amber-500"></div> Logs/Backup
              </div>
        ...
        <div className="lg:col-span-2 bg-white rounded-xl border border-slate-200 shadow-sm overflow-hidden">
          ...
          <div className="divide-y divide-slate-100">
            {[
              {
                type: "High Load",
                msg: "App Server 03 CPU vượt quá 90%",
                time: "10 phút trước",
                severity: "high",
              },
              {
                type: "Latency",
                msg: "API Gateway phản hồi chậm > 2000ms",
                time: "32 phút trước",
                severity: "medium",
              },
              {
                type: "Storage",
                msg: "Ổ đĩa /var/log đầy 85%",
                time: "2 giờ trước",
                severity: "low",
              },
              {
                type: "Security",
                msg: "Phát hiện đăng nhập bất thường IP 192.168.x.x",
                time: "5 giờ trước",
                severity: "medium",
              },
              {
                type: "Backup",
                msg: "Backup Database thành công",
                time: "1 ngày trước",
                severity: "info",
              },
            ].map((alert, idx) => (
