    ...
    messages: [
      {
        id: "m1",
        senderId: "u001",
        text: "Chào anh, cho em hỏi về quy trình duyệt budget Q4 ạ.",
      ...
      },
      {
        id: "m2",
        senderId: "admin",
        text: "Chào Hoa, em xem trong thư mục Shared Drive > Finance nhé.",
      ...
      },
      {
        id: "m3",
        senderId: "u001",
        text: "Dạ em thấy rồi ạ. Cảm ơn anh.",
    ...
    messages: [
      {
        id: "m1",
        senderId: "u002",
        text: "Server staging đang bị lỗi 502 anh ơi.",
    ...
    messages: [
      {
        id: "m1",
        senderId: "admin",
        text: "File design banner sự kiện chốt chưa em?",
...
const ChatInfoPanel = ({
  ...
  const allAttachments = conversation.messages.flatMap(
    (m) => m.attachments || []
  );
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-4 space-y-6">
        ...
        <div className="text-center">
          ...
          <p className="text-sm text-slate-500">
            {fullProfile?.position || "Nhân viên"}
          </p>
          <p className="text-xs text-brand-600 font-medium">
            {fullProfile?.department || "Nexus Corp"}
          </p>
          ...
          <div className="space-y-3 text-sm">
            <div className="flex items-center gap-3 text-slate-600">
              ...
              <span className="truncate">
                {fullProfile?.email || "email@nexus.com"}
              </span>
            </div>
            <div className="flex items-center gap-3 text-slate-600">
            ...
            {activeTab === "files" && (
              <div className="space-y-2">
                {files.map((file, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-3 p-2 rounded-lg hover:bg-slate-50 border border-transparent hover:border-slate-200 transition-colors cursor-pointer group"
                  >
  ...
  const displayMessages = activeConversation?.messages.filter((m) => {
    ...
    return (
      ...
      m.attachments?.some((a) =>
        a.name.toLowerCase().includes(chatSearchQuery.toLowerCase())
      )
    );
  });
              ...
              <div className="relative flex-shrink-0">
                ...
                <span
                  className={`absolute bottom-0 right-0 w-3 h-3 rounded-full border-2 border-white ${
                    conv.userStatus === "online"
                      ? "bg-green-500"
                      : conv.userStatus === "busy"
                      ? "bg-red-500"
                      : "bg-slate-400"
                  }`}
                ></span>
                ...
                <div className="relative">
                  ...
                  <span
                    className={`absolute bottom-0 right-0 w-2.5 h-2.5 rounded-full border-2 border-white ${
                      activeConversation.userStatus === "online"
                        ? "bg-green-500"
                        : activeConversation.userStatus === "busy"
                        ? "bg-red-500"
                        : "bg-slate-400"
                    }`}
                  ></span>
              ...
              {displayMessages && displayMessages.length > 0 ? (
                displayMessages.map((msg, idx) => {
                  ...
                  const showAvatar =
                    !isMe &&
                    (idx === 0 ||
                      activeConversation.messages[idx - 1]?.senderId !==
                        msg.senderId);
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`max-w-[70%]`}>
                          ...
                          >
                            {att.type === "image" ? (
                              <img
                                src={att.url}
                                alt={att.name}
                                className="max-w-full rounded-lg border border-slate-200 shadow-sm max-h-60 object-cover"
                              />
                            ) : (
                              <div
                        ...
                        <div
                          className={`text-[10px] mt-1 text-slate-400 opacity-0 group-hover:opacity-100 transition-opacity flex items-center gap-1 ${
                            isMe ? "justify-end" : "justify-start"
                          }`}
                        >
            ...
            <div className="p-4 bg-white border-t border-slate-200 flex-shrink-0">
              ...
              <div className="text-center mt-2">
                <p className="text-[10px] text-slate-400">
                  Nhấn <span className="font-bold">Enter</span> để gửi,{" "}
                  <span className="font-bold">Shift + Enter</span> để xuống
                  dòng.
                </p>
              </div>
            </div>
