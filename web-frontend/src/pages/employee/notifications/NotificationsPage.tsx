...
const NotificationsPage: React.FC = () => {
  ...
  const getNotificationIcon = (type: string) => {
    const iconMap: Record<string, React.ReactNode> = {
      ...
      news: <Info className="w-5 h-5 text-blue-500" />,
      announcement: <Bell className="w-5 h-5 text-orange-500" />,
    };
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h1 className="text-3xl font-bold text-slate-900 flex items-center gap-3">
              <Bell className="text-teal-600" /> Thông báo
            </h1>
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              ...
              <p className="text-slate-500 mt-1 max-w-sm">
                {filter === "unread"
                  ...
                  : "Chúng tôi sẽ thông báo khi có thông tin quan trọng từ công ty."}
              </p>
            </div>
          ) : (
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-3 mt-3">
                        ...
                        {!notification.isRead && (
                          <span className="text-[10px] font-bold uppercase tracking-wider text-teal-600 bg-teal-50 px-2 py-1 rounded flex items-center gap-1">
                            Mới
                          </span>
                        )}
                      </div>
