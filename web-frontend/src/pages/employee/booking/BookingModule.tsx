...
export const BookingModule = () => {
  ...
  const loadRoomAvailability = async () => {
    try {
      const data = await roomService.getRoomAvailability(
        selectedDate,
        selectedFloorId
      );
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 max-w-7xl mx-auto">
            <div>
              ...
              <p className="text-slate-500 mt-1 max-w-xl">
                Tìm và đặt phòng họp phù hợp. Lọc theo tầng, thời gian hoặc sức
                chứa.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            <div className="flex-1 min-w-0">
                ...
                <div className="flex flex-wrap items-center gap-2">
                  ...
                  <div className="relative group min-w-[220px] flex-1 md:flex-none">
                    ...
                    <select
                      ...
                      className="w-full pl-10 pr-10 py-2.5 bg-slate-50 hover:bg-slate-100 border-none rounded-lg text-sm font-semibold text-slate-900 focus:ring-2 focus:ring-teal-500/20 cursor-pointer appearance-none transition-colors"
                    >
                      {floors.map((floor) => (
                  ...
                  <div className="relative group min-w-[180px] flex-1 md:flex-none">
                    ...
                    <input
                      ...
                      className="w-full pl-10 pr-3 py-2.5 bg-slate-50 hover:bg-slate-100 rounded-lg text-sm font-semibold text-slate-900 border-none focus:ring-2 focus:ring-teal-500/20 cursor-pointer transition-colors"
                    />
                  </div>
              ...
              <div className="flex items-center justify-between mb-6 px-1">
                <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
                  <span className="w-1.5 h-6 rounded-full bg-teal-600 inline-block"></span>
              ...
              {roomAvailability.length > 0 ? (
                      ...
                      >
                        <div className="flex h-full">
                          ...
                          <div className="flex-1 p-5 flex flex-col">
                            ...
                            <p className="text-xs text-slate-500 uppercase tracking-wide font-semibold mb-4 opacity-80">
                              {room.roomType}
                            </p>
                            ...
                            <div className="mt-auto pt-4 border-t border-slate-100 border-dashed">
                              ...
                              room.bookings.length > 0 ? (
                                <div className="bg-slate-50 rounded-lg p-2.5">
                                  ...
                                  <div className="flex justify-between items-center text-[10px] text-slate-500">
                                    <div className="flex items-center gap-1">
                                      <Clock size={10} />
                                      {room.bookings[0].startTime.substring(
                                        0,
                                        5
                                      )}{" "}
                                      -{" "}
                                      {room.bookings[0].endTime.substring(0, 5)}
                                    </div>
                                    <div className="flex items-center gap-1">
                                      <div className="w-4 h-4 rounded-full bg-teal-100 text-teal-700 flex items-center justify-center font-bold">
                                ...
                                <div className="flex items-center justify-between group-hover:bg-slate-50 -mx-2 -my-1 px-2 py-1 rounded-lg transition-colors">
                                  ...
                                  <div className="w-8 h-8 rounded-full bg-teal-50 flex items-center justify-center text-teal-600 opacity-0 group-hover:opacity-100 transition-all transform translate-x-2 group-hover:translate-x-0">
                ...
                <div className="flex flex-col items-center justify-center py-20 bg-white rounded-xl border border-slate-200 border-dashed">
                  ...
                  <p className="text-slate-500 text-center max-w-xs">
                    Không có phòng nào phù hợp với tiêu chí của bạn. Hãy thử
                    thay đổi tầng hoặc thời gian.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="w-full lg:w-80 space-y-6 lg:sticky lg:top-24 h-fit">
              {/* Summary Widget */}
              <div className="bg-gradient-to-br from-teal-600 to-teal-700 rounded-2xl shadow-lg p-6 text-white relative overflow-hidden">
                ...
                <p className="text-teal-100 text-sm mb-6 relative z-10">
                  ...
                  cuộc họp đã được duyệt.
                </p>

                <div className="grid grid-cols-2 gap-3 relative z-10">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/10">
                    <p className="text-2xl font-bold">{userBookings.length}</p>
                    <p className="text-[10px] uppercase tracking-wider text-teal-100 font-medium">
                      Tổng đặt phòng
                    </p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-3 border border-white/10">
                      ...
                      >
                        <div className="flex justify-between items-start mb-1.5">
                          <div className="flex-1 min-w-0 pr-2">
                            <p className="font-bold text-slate-800 text-sm truncate group-hover:text-teal-600 transition-colors">
